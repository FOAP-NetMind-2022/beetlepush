 ...
 * *********************/ 
  ...
  `,
  instructions: "<div>To pass this level you need to use <strong>push()</strong> method to add a new ladybug at the end array myGrass.<br><br>For example in this level the solution is:<br><br><b>myGrass.push('ladybug');</b></div>"
  ,
